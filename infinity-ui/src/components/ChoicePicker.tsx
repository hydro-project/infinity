...
export const ChoicePicker = forwardRef<ChoicePickerHandle, Props>(
  function ChoicePicker(
    { prompt, choices, defaultIndex, onSelect, onFocusInput },
    fwdRef,
  ) {
          ...
          <div className={css.choices}>
            {choices.map((choice, i) => (
              ...
              >
                {choice}
                {i === defaultIndex && (
                  <span className={css.defaultTag}>(default)</span>
                )}
              </button>
            ))}
          </div>
