...
- **Sandboxed editing** — changes happen in isolated workspaces. Supports [Jujutsu](./coding-with-jj.md) (recommended), [Git](./coding-with-git.md), and [Brazil](./coding-with-brazil.md).
