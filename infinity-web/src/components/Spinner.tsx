...
const HYDRO: [number, number, number][] = [
  [0, 150, 255], [1, 158, 243], [3, 167, 231], [5, 175, 220],
  [7, 184, 208], [9, 193, 196], [11, 201, 185], [13, 210, 173],
  [15, 219, 162], [13, 210, 173], [11, 201, 185], [9, 193, 196],
  [7, 184, 208], [5, 175, 220], [3, 167, 231], [1, 158, 243],
];

const WARM: [number, number, number][] = [
  [180, 60, 20], [210, 80, 25], [240, 120, 40], [255, 160, 60],
  [255, 180, 80], [255, 160, 60], [240, 120, 40], [210, 80, 25],
];
    ...
    function draw() {
      ...
      for (let i = 0; i < NUM_BARS; i++) {
        ...
        if (state === 'loading') {
          ...
          const ci = Math.min(Math.floor(wave * (WARM.length - 1)), WARM.length - 1);
          ...
          for (let s = 0; s <= steps; s++) {
            ...
            grad.addColorStop(t, `rgb(${Math.round(cr)},${Math.round(cg)},${Math.round(cb)})`);
          }
          ctx.fillStyle = grad;
          ctx.beginPath();
